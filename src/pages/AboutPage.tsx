      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-lg max-w-2xl mx-auto" style={{ color: 'var(--text-secondary)', lineHeight: 1.8 }}>
            أديب ماركت هي مجلة رقمية عربية احترافية أسسها Adeeb Ali بهدف إثراء المحتوى العربي في مجالات التسويق الرقمي والذكاء الاصطناعي وريادة الأعمال.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
          {values.map((v, i) => (
            ...
            >
              <div className="w-14 h-14 rounded-2xl bg-gold/10 flex items-center justify-center text-gold mb-4">
                {v.icon}
              </div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="glass-card rounded-3xl p-8 sm:p-12 text-center mb-16"
        >
          <h2 className="text-2xl font-bold mb-8" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-heading)' }}>
            المؤسس
          </h2>
          ...
          <p className="max-w-xl mx-auto" style={{ color: 'var(--text-secondary)', lineHeight: 1.8 }}>
            {author.bio}
          </p>
        </motion.div>
        ...
        >
          {[
            { num: '50+', label: 'مقال منشور' },
            { num: '15K+', label: 'قارئ شهري' },
            { num: '6', label: 'تصنيفات' },
            { num: '3K+', label: 'مشترك نشرة' },
          ].map((stat, i) => (
