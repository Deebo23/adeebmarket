  ...
  return (
    <div className="pt-24 sm:pt-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* Other Categories */}
        <div className="mt-16">
          <h2 className="text-xl font-bold mb-6 text-center" style={{ color: 'var(--text-primary)', fontFamily: 'var(--font-heading)' }}>
            تصنيفات أخرى
          </h2>
          <div className="flex flex-wrap justify-center gap-3">
            {categories.filter(c => c.slug !== slug).map(cat => (
              <Link
                ...
                className="glass-card px-5 py-3 rounded-xl text-sm font-medium flex items-center gap-2 hover:text-gold transition-colors"
